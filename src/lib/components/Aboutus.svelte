<section class="mx-auto bg-[#f8f3eb] max-w-7xl ">
  
    <div class=" mx-auto flex flex-col justify-between items-center gap-2.5 px-3 md:px-6 lg:flex-row">
      <!-- Left Content -->
      <div class="md:w-[637px] text-center md:text-left">
        <p class=" tracking-wide text-[#5A4635]">About Us</p>
        <h2 class="mt-4 text-2xl font-semibold md:text-4xl leading-snug text-[#5A4635]">
          Transforming Spaces with <br /> Expertise and Excellence
        </h2>
        <p class="mt-6 text-[#766D66]">
